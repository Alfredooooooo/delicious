                                ...
                                <SplideSlide key={recipe.id}>
                                    ...
                                    >
                                        <div className="h-[25rem] rounded-[2rem] overflow-hidden relative transition delay-700 duration-300 ease-in-out">
                                            ...
                                            ></Image>
                                            <p className="absolute z-10 left-1/2 bottom-0 text-white font-semibold -translate-x-1/2 -translate-y-0 w-[90%] h-[30%] text-center flex items-center justify-center overflow-y-hidden">
                                                {recipe.title}
                                            </p>
